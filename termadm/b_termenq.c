...
/* revision history:
	...
	Update puts terminal-type 'screen' ahead of 'vt100'.  This still
	uses an internal database for the various terminal attributes. A 
	reasonable future enhancement would be to read this database in
	from a file.
